...
export default function ChatFlow({
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <form onSubmit={handleSubmit} className="flex-shrink-0 px-3 py-3 bg-white/80 backdrop-blur-md border-t border-gray-100 safe-area-bottom">
        <div className="flex gap-1.5 items-center relative">
          <button
            type="button"
            onClick={() => setShowMenu(!showMenu)}
            className="flex-shrink-0 w-9 h-9 flex items-center justify-center rounded-full bg-gray-100 text-gray-600 hover:bg-gray-200 transition-all active:scale-95"
          >
            <svg
          ...
          {showMenu && (
            <div className="absolute bottom-12 left-0 bg-white rounded-2xl shadow-xl border border-gray-100 p-2 min-w-[130px] z-10">
              <button
                onClick={() => {
                  setShowMenu(false);
                  inputRef.current?.focus();
          ...
          <button
            ...
            className="flex-shrink-0 w-9 h-9 flex items-center justify-center bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-full hover:shadow-lg hover:shadow-blue-500/30 disabled:from-gray-300 disabled:to-gray-300 disabled:cursor-not-allowed transition-all active:scale-95"
          >
            {checkingGrammar ? (
              <svg
